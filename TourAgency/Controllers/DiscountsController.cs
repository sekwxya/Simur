...
namespace TourAgency.Controllers
{
    public class DiscountsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DiscountId,Name,DiscountPercentage")] Discount discount)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DiscountId,Name,DiscountPercentage")] Discount discount)
        {
